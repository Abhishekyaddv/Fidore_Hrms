...
export function AddPolicyModal({ isOpen, setIsOpen }: AddPolicyModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post(route('company-policies.store'), submitData, {
            onSuccess: () => {
                setIsOpen(false);
                resetForm();
            },
                            ...
                            <Dialog.Panel className="w-full max-w-xl transform overflow-hidden rounded-2xl bg-white p-8 text-left align-middle shadow-2xl transition-all">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5">
                                    ...
                                    <div className="space-y-1.5 pt-2">
                                        <Label className="text-[#051C3F] font-semibold">Upload Document (PDF/DOC) *</Label>
                                            ...
                                            <div className="text-center">
                                                {document ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <p className="text-xs leading-5 text-gray-500 mt-1">PDF, DOC, DOCX up to 10MB</p>
                                                    </>
                                                )}
                                            </div>
                                        </div>
